...
def test_production_rejects_known_insecure_secret_values(
    ...
    values = {
        ...
        "sub2api_contract_marker": "0.2.1/578785e",
    }
...
def test_production_requires_the_exact_frozen_sub2api_marker(
    ...
    with pytest.raises(ValidationError):
        Settings(**common, sub2api_contract_marker="0.2.1/wrong")

    settings = Settings(**common, sub2api_contract_marker="0.2.1/578785e")
