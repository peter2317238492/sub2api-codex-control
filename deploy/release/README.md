...
deploy/release/verify-control-images.sh \
  ...
  --certificate-identity \
    https://github.com/OWNER/REPOSITORY/.github/workflows/control-images-release.yml@refs/tags/control-v0.1.12 \
  ...
  --certificate-github-workflow-ref refs/tags/control-v0.1.12 \
  ...
  --expected-release-tag control-v0.1.12 \
...
```sh
install -d -m 0700 /secure/staging/control-v0.1.12-offline-parent
/usr/bin/python3 -I /secure/download/control-v0.1.12/server/server-package-verify.py verify-release \
  --release-dir /secure/download/control-v0.1.12/server \
  --extract-to /secure/staging/control-v0.1.12-offline-parent \
  --mode offline \
  --verification-receipt /secure/receipts/control-v0.1.12-offline.json \
