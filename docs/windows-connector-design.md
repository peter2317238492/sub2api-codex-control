...
| ACL must not grant access to others | DACL must be present and non-NULL; every non-inherit-only **allow** ACE must name the owner SID, `S-1-5-18`, or `S-1-5-32-544`. Any other allow trustee fails closed. |
