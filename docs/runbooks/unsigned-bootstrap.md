...
CONTROL_SUB2API_CONTRACT_MARKER=0.2.1/578785e
...
test "$(stat -f '%Lp' "$stage/docs/contracts/sub2api-auth.v0.2.1.json" 2>/dev/null || stat -c '%a' "$stage/docs/contracts/sub2api-auth.v0.2.1.json")" = 444

SUB2API_CONTAINER=sub2api \
VERSIONS_LOCK_FILE="$stage/versions.lock.json" \
SUB2API_AUTH_CONTRACT_FILE="$stage/docs/contracts/sub2api-auth.v0.2.1.json" \
