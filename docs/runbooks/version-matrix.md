...
| --- | --- | --- |
| Control API | `0.1.13` candidate: preserves the admitted runtime auth-contract snapshot as `0444` and creates a separately hashed `0600` auth-probe copy. Published `control-v0.1.12` passed all ten release jobs and host verification; installation stopped before service mutation because its runtime contract copy was `0600`. | Candidate requires a new signed release and production acceptance |
| PWA | `0.1.13` (versioned together with the Control API release tag) | PWA image digest built from the same release commit |
...
| Sub2API official image | Immutable index `weishaw/sub2api@sha256:b3845aad81d728a5e4efa4d677a638f27947be286ed9a17788a42a1f07fe7e50`; selected amd64 manifest `sha256:86d605217e7ebdb60a70316a458446cd51c2da207a8b2128661a2cb9caaf9aab`; labels `0.2.1/578785ee` | `immutable-image-v1`; exact index, image ID, binary, labels, and stable live container identity |
| Sub2API runtime binary | `0.2.1`, commit `578785ee7fb35030b094b69624efe25670a36f5f`, build `2026-09-05T09:34:19Z`, size `119656608`, SHA-256 `b709a61c22bfb6b662619658444e20186fdfd8d1850984fa9a909572c0a5026a` | Production file and checksum-verified official archive match; fresh PID 1 acceptance still required |
...
| Sub2API auth contract | `docs/contracts/sub2api-auth.v0.2.1.json`, SHA-256 `3affbb6ade0b4d6d97df9f2ea3834049e94f64798267763c0c2353cd1f494594`; pinned auth sources are unchanged from `v0.2.0` | Fresh identity, refresh, logout, disabled-user and revoked-token acceptance required at deployment |
...
prove the current production host runs the `0.2.1` immutable tuple.
