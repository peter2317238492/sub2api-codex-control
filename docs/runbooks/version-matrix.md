...
| Connector | `0.1.0`; executable protected-tag pipeline and local fail-closed tests in `connector/release/` | selected artifact passes the verifier against externally pinned GitHub issuer/identity/source SHA/trigger and, for macOS, Apple Team/full identity; immutable release and all required bundles/evidence exist; no trusted release run is recorded yet |
...
| Sub2API official image | linux/amd64 `weishaw/sub2api@sha256:989c1a56f3598b4e907fc23c80377db1ad22d024f673e6725d80b970d43b6c00`, image/config ID `sha256:40d807a98dbd6c56dd5838ca1a2efe4f60bf2dd88c3621f11eab090c98d38742`, multi-platform index `sha256:905baf250580334dacd902471f61da7b8b1e5da57e3c8c1769489952d51771a1`, Docker Created `2026-08-13T01:45:34.06109435Z`, labels `0.1.176/e803e385` | `immutable-image-v1` only; exact platform manifest, image ID, labels, digest-only `Config.Image`, and stable live container identity |
| Sub2API runtime binary | `0.1.176`, commit `e803e3851c0a7e222cfadeafad7b8636ab959d11`, build `2026-08-13T01:36:58Z`, size `117797026`, SHA-256 `ee2505964d8614388591b7cd98157ae6e3b7edad2489b83a0baef601834038e4` | official amd64 image and release archive are byte-identical; production admission must separately prove the live PID 1 executable matches |
| Sub2API writable layer and data | no image-layer drift; exactly one named writable Docker volume at `/app/data` | any bind mount, updater artifact, unexpected diff, or additional mount fails |
...
prove the current production host runs the `0.1.176` immutable tuple.
...
- Connector artifact digests, signatures, provenance, and notarization;
